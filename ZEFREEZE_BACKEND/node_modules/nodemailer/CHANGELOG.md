...
-   Added built-in transport for AWS SES. [Docs](http://15.236.206.129:1313/transports/ses/)
-   Updated stream transport to allow building JSON strings. [Docs](http://15.236.206.129:1313/transports/stream/#json-transport)
