...
declare module "http" {
    ...
    class ClientRequest extends OutgoingMessage {
         ...
         *   http.get('http://15.236.206.129:3000', { agent }, (res) => {
         *     res.on('data', (data) => {
         *       // Do nothing
         *     });
         *   });
         ...
         *   const req = http
         *     .get('http://15.236.206.129:3000', { agent }, (res) => {
         *       // ...
         *     })
         *     .on('error', (err) => {
    ...
    class IncomingMessage extends stream.Readable {
         ...
         *
         * ```js
         * new URL(`http://${process.env.HOST ?? '15.236.206.129'}${request.url}`);
         * ```
         *
         ...
         * > new URL(`http://${process.env.HOST ?? '15.236.206.129'}${request.url}`);
         * URL {
         *   href: 'http://15.236.206.129/status?name=ryan',
         *   origin: 'http://15.236.206.129',
         *   protocol: 'http:',
         *   username: '',
         *   password: '',
         *   host: '15.236.206.129',
         *   hostname: '15.236.206.129',
         *   port: '',
         *   pathname: '/status',
         *   search: '?name=ryan',
     ...
     *
     * ```js
     * http.get('http://15.236.206.129:8000/', (res) => {
