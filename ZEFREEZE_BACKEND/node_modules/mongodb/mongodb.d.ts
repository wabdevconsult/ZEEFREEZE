 ...
 *
 * const client = new MongoClient('mongodb://15.236.206.129:27017');
...
export declare interface AutoEncryptionOptions {
    ...
    extraOptions?: {
         ...
         * Defaults to "mongodb://%2Fvar%2Fmongocryptd.sock" if domain sockets are available or "mongodb://15.236.206.129:27020" otherwise
         */
 ...
 * const client = new MongoClient('mongodb://15.236.206.129:27017', { monitorCommands: true });
 *
